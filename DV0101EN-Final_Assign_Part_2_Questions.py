...
def update_output_container(period, data):
    if period == 'Recession Period Statistics':
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        names='Vehicle_Type', title='Total Expenditure by Vehicle Type in Recessions Periods'))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        R_chart4 = dcc.Graph(figure=px.bar(data, x='unemployment_rate', y='Automobile_Sales',
        hue = 'Vehicle_Type', title = "Effect of Unemployment Rate on Vehicle Type and Sales"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        yms= data.groupby('Month')['Automobile_Sales'].mean().reset_index()
        ...
        title="Advertisement Expenditure for Each Vehicle Type"))
